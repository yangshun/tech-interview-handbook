...
_By [Lior Neu-ner](https://www.linkedin.com/in/liornn/) — former Meta engineering manager and founder of [Remote Rocketship](http://remoterocketship.com/), a job board for remote tech jobs._
...
To assess these focus areas, interviewers ask questions on your work history and dig into the details of how you handled various situations. To assess the your seniority, for each focus area they determine if the scope of the situation is something they would expect for a junior, senior, or staff engineer (more details on this below).
...
**Ablility to work in an unstructured environment:**
...
- Tell me about a time a project took longer as expected Example Responses:
...
![The spectrum of the no-hire to hire interviewing decision overlayed on the interviewer's confidence](https://imgur.com/zRma48X)
